<footer id="footer" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500">
            ...
            <div class="container">
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>Our Services</h4>
                    <ul>
                    <li><i class="bx bx-chevron-right"></i> <a href="#">Parcel Pickup</a></li>
                    <li><i class="bx bx-chevron-right"></i> <a href="#">Parcel Delivery</a></li>
            ...
            <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>Pathao Courier</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
